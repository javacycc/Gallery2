...
//        FragmentTransaction transaction = getChildFragmentManager().beginTransaction();
//        transaction.replace(R.id.category_panel_container, , CategoryPanel.FRAGMENT_TAG);
//        transaction.commit();
//        //
////        ViewGroup group = (ViewGroup) mMainView.findViewById(R.id.category_panel_container);
////        CategoryPanel view = new CategoryPanel();
////        view.setActivity(getActivity());
////        view.loadAdapter(LOOKS);
////       
////        View v = view.onCreateView(getActivity().getLayoutInflater(), group, null);
//        
//        
