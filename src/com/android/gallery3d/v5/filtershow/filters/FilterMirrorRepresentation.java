...
public class FilterMirrorRepresentation extends FilterRepresentation {
    ...
    public static final int MIRROR_DIRECTION_LEFT_RIGHT = 0xff222;
    public static final int MIRROR_DIRECTION_TOP_BUTTOM = 0xff223;
    static int mirroDirection = MIRROR_DIRECTION_LEFT_RIGHT;
    Mirror mMirror;
    ...
    public void setMirroDirection(int direction){
    	mirroDirection = direction;
    }
    ...
    public void cycle() {
        switch (mMirror) {
            case NONE:
            	if(mirroDirection==MIRROR_DIRECTION_LEFT_RIGHT){
            		mMirror = Mirror.HORIZONTAL;
            	}
            	if(mirroDirection==MIRROR_DIRECTION_TOP_BUTTOM){
            		mMirror = Mirror.VERTICAL;
            	}
                break;
            case HORIZONTAL:
