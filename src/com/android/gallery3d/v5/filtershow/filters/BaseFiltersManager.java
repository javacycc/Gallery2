...
//        borderList.add(rep);
    ...
    public FilterRepresentation getCurvesRepresentation(){
    	return getRepresentation(ImageFilterCurves.class);
    }
...
//        mEffects.add(getRepresentation(ImageFilterKMeans.class));
    ...
    public void addTools(Context context) {
        ...
        FilterRepresentation[] geometryFilters = {
                ...
                new LewaFilterRotateRepresentation(new FilterRotateRepresentation(),new FilterMirrorRepresentation()),
