...
package com.android.gallery3d.v5.filtershow.history;
...
public class HistoryManager {
    ...
    public void printHistorys(){
    	...
    	for(HistoryItem item : mHistoryItems){
    		log.append(item.getFilterRepresentation()==null?"null":item.getFilterRepresentation().getName()+"|");
    	}
    	Log.i("History","currentPos="+mCurrentPresetPosition+"|"+ log.toString());
    }
    public void reset() {
        if (getCount() == 0) {
            return;
