...
package com.android.gallery3d.v5.filtershow.cache;
...
import com.android.gallery3d.v5.filtershow.pipeline.CacheProcessing;
...
public class BitmapCache {
    ...
    public void clearCache(){
    	...
    	Set<Entry<Long, ArrayList<WeakReference<Bitmap>>>> entrys = mBitmapCache.entrySet();
    	for(Entry<Long, ArrayList<WeakReference<Bitmap>>> entry : entrys){
    		 ArrayList<WeakReference<Bitmap>> wRefs = entry.getValue();
    		 for(WeakReference<Bitmap> wRef : wRefs){
    ...
    public synchronized Bitmap getBitmap(int w, int h, int type) {
        ...
        //Log.d(LOGTAG, "getbitmap w="+w+":h="+h);
        if (bitmap == null
                || bitmap.getWidth() != w
                || bitmap.getHeight() != h) {
