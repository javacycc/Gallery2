...
import com.android.gallery3d.v5.filtershow.pipeline.Buffer;
import com.android.gallery3d.v5.filtershow.pipeline.ImagePreset;
import com.android.gallery3d.v5.filtershow.pipeline.RenderingRequest;
import com.android.gallery3d.v5.filtershow.pipeline.RenderingRequestCaller;
import com.android.gallery3d.v5.filtershow.pipeline.SharedBuffer;
import com.android.gallery3d.v5.filtershow.pipeline.SharedPreset;
...
public class MasterImage implements RenderingRequestCaller {
    ...
    public static final int MAX_BITMAP_DIM = 1200; 
    ...
    private MasterImage() {
    	Log.d(LOGTAG, "MasterImage Create!");
    }
    ...
    public void setCurrentFilterRepresentation(FilterRepresentation currentFilterRepresentation) {
    	Log.d(LOGTAG, "setCurrentFilterRepresentation="+currentFilterRepresentation);
