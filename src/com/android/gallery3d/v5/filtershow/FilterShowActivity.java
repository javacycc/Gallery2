...
package com.android.gallery3d.v5.filtershow;
...
import com.android.gallery3d.v5.filtershow.cache.ImageLoader;
import com.android.gallery3d.v5.filtershow.category.Action;
...
import com.android.gallery3d.v5.filtershow.category.CategorySelected;
...
import com.android.gallery3d.v5.filtershow.category.SwipableView;
import com.android.gallery3d.v5.filtershow.category.lewa.LewaEditorBaseFragment;
import com.android.gallery3d.v5.filtershow.category.lewa.LewaMainPanel;
import com.android.gallery3d.v5.filtershow.data.UserPresetsManager;
import com.android.gallery3d.v5.filtershow.editors.BasicEditor;
import com.android.gallery3d.v5.filtershow.editors.Editor;
import com.android.gallery3d.v5.filtershow.editors.EditorChanSat;
import com.android.gallery3d.v5.filtershow.editors.EditorColorBorder;
...
import com.android.gallery3d.v5.filtershow.editors.EditorDraw;
import com.android.gallery3d.v5.filtershow.editors.EditorGrad;
import com.android.gallery3d.v5.filtershow.editors.EditorManager;
import com.android.gallery3d.v5.filtershow.editors.EditorMirror;
import com.android.gallery3d.v5.filtershow.editors.EditorPanel;
import com.android.gallery3d.v5.filtershow.editors.EditorRedEye;
import com.android.gallery3d.v5.filtershow.editors.EditorRotate;
import com.android.gallery3d.v5.filtershow.editors.EditorStraighten;
import com.android.gallery3d.v5.filtershow.editors.EditorTinyPlanet;
import com.android.gallery3d.v5.filtershow.editors.EditorVignette;
import com.android.gallery3d.v5.filtershow.editors.ImageOnlyEditor;
import com.android.gallery3d.v5.filtershow.filters.FilterDrawRepresentation;
...
import com.android.gallery3d.v5.filtershow.filters.FilterStraightenRepresentation;
import com.android.gallery3d.v5.filtershow.filters.FilterUserPresetRepresentation;
import com.android.gallery3d.v5.filtershow.filters.FiltersManager;
import com.android.gallery3d.v5.filtershow.filters.ImageFilter;
...
import com.android.gallery3d.v5.filtershow.imageshow.ImageShow;
...
import com.android.gallery3d.v5.filtershow.info.InfoPanel;
import com.android.gallery3d.v5.filtershow.pipeline.CachingPipeline;
import com.android.gallery3d.v5.filtershow.pipeline.ImagePreset;
import com.android.gallery3d.v5.filtershow.pipeline.ProcessingService;
import com.android.gallery3d.v5.filtershow.presets.PresetManagementDialog;
import com.android.gallery3d.v5.filtershow.presets.UserPresetsAdapter;
import com.android.gallery3d.v5.filtershow.provider.SharedImageProvider;
import com.android.gallery3d.v5.filtershow.state.StateAdapter;
import com.android.gallery3d.v5.filtershow.tools.SaveImage;
import com.android.gallery3d.v5.filtershow.tools.XmpPresets;
import com.android.gallery3d.v5.filtershow.tools.XmpPresets.XMresults;
import com.android.gallery3d.v5.filtershow.ui.ExportDialog;
import com.android.gallery3d.v5.filtershow.ui.FramedTextButton;
...
public class FilterShowActivity extends FragmentActivity implements OnItemClickListener,
    ...
    private View mEditorCancelButton = null;
    private View mEditorApplyButton = null;
    private View mResetButton = null;
    ...
    public boolean isSimpleEditAction() {
        return !"action_nextgen_edit".equalsIgnoreCase(mAction);
    }
    ...
    public void showPanelActionButton(){
    	mReturnButton.setVisibility(View.GONE);
    	mSaveButton.setVisibility(View.GONE);
    	mResetButton.setVisibility(View.GONE);
    	mEditorCancelButton.findViewById(R.id.editor_action_cancel).setVisibility(View.VISIBLE);
    	mEditorApplyButton.setVisibility(View.VISIBLE);
    }
    public void showMainActionButton(){
    	mReturnButton.setVisibility(View.VISIBLE);
    	mSaveButton.setVisibility(View.VISIBLE);
    	mResetButton.setVisibility(View.GONE);
    	mEditorCancelButton.setVisibility(View.GONE);
    	mEditorApplyButton.setVisibility(View.GONE);
    }
    @Override
    ...
    private void loadXML() {
        ...
        actionBar.setCustomView(LayoutInflater.from(this).inflate(R.layout.filtershow_actionbar, null),new ActionBar.LayoutParams(ActionBar.LayoutParams.MATCH_PARENT, ActionBar.LayoutParams.MATCH_PARENT));
        ...
        mEditorCancelButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Fragment fragment = getSupportFragmentManager().findFragmentByTag( MainPanel.FRAGMENT_TAG);
		    	 Fragment editorFrament = fragment.getChildFragmentManager().findFragmentByTag(CategoryPanel.FRAGMENT_TAG);
    ...
    public void showFilterRepresentation(FilterRepresentation representation,EditorPanel panel){
        if (representation == null) { 
            return;
        }
        ...
        panel.setEditor(mCurrentEditor.getID());
        panel.resetPanel();
    }
    public void showFilterRepresentation(FilterRepresentation representation){
    	 if (representation == null) {
             return;
         }
    	 Fragment fragment = getSupportFragmentManager().findFragmentByTag( MainPanel.FRAGMENT_TAG);
    	 Fragment editorFrament = fragment.getChildFragmentManager().findFragmentByTag(CategoryPanel.FRAGMENT_TAG);
    	 if(editorFrament instanceof EditorPanel){
    		 showFilterRepresentation(representation,(EditorPanel)editorFrament);
    	 }
    }
    public void showRepresentation(FilterRepresentation representation) {
        ...
        if(fragment instanceof EditorPanel){
        	showFilterRepresentation(representation,(EditorPanel)fragment);
        	return;
        }
    ...
    protected void onDestroy() {
        ...
        //MasterImage.getImage().getBitmapCache().clearCache();
        System.gc();
        super.onDestroy();
    }
...
//        setupMenu();
    ...
    public void backToMain() {
        ...
        if (currentPanel instanceof LewaMainPanel) {
        	((LewaMainPanel)currentPanel).showMainTabPanel();
        	 showDefaultImageView();
            return;
        }
    ...
    public void onBackPressed() {
        Fragment currentPanel = getSupportFragmentManager().findFragmentByTag(MainPanel.FRAGMENT_TAG);
        if (currentPanel instanceof LewaMainPanel){
        	if(((LewaMainPanel)currentPanel).onBackPressed()) return;
    ...
    public void saveImage() {
        if (mImageShow.hasModifications()) {
            ...
            //int bucketId = getBucketId(saveDir.getPath());
            //String albumName = getString(R.string.app_name);//= LocalAlbum.getLocalizedName(getResources(), bucketId, null);
           showSavingProgress(null);
