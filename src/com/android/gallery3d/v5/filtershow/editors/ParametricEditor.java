...
import com.android.gallery3d.v5.filtershow.controller.ActionSlider;
import com.android.gallery3d.v5.filtershow.controller.BasicSlider;
import com.android.gallery3d.v5.filtershow.controller.ColorChooser;
...
import com.android.gallery3d.v5.filtershow.controller.ParameterActionAndInt;
import com.android.gallery3d.v5.filtershow.controller.ParameterBrightness;
import com.android.gallery3d.v5.filtershow.controller.ParameterColor;
import com.android.gallery3d.v5.filtershow.controller.ParameterHue;
import com.android.gallery3d.v5.filtershow.controller.ParameterInteger;
import com.android.gallery3d.v5.filtershow.controller.ParameterOpacity;
import com.android.gallery3d.v5.filtershow.controller.ParameterSaturation;
import com.android.gallery3d.v5.filtershow.controller.ParameterStyles;
import com.android.gallery3d.v5.filtershow.controller.SliderBrightness;
import com.android.gallery3d.v5.filtershow.controller.SliderHue;
import com.android.gallery3d.v5.filtershow.controller.SliderOpacity;
import com.android.gallery3d.v5.filtershow.controller.SliderSaturation;
import com.android.gallery3d.v5.filtershow.controller.StyleChooser;
import com.android.gallery3d.v5.filtershow.controller.TitledSlider;
...
public class ParametricEditor extends Editor {
    ...
    public void reflectCurrentFilter() {
        ...
        if (getLocalRepresentation() != null
            ...
            FilterBasicRepresentation interval = (FilterBasicRepresentation) getLocalRepresentation();
            if(mControl!=null) mControl.setPrameter(interval);
        }
    }
    ...
    protected void control(Parameter p, View editControl) {
        ...
        Log.e(LOGTAG, "get Control class from hashmap="+c);
        if (c != null) {
            try {
