...
package com.android.gallery3d.v5.filtershow.pipeline;
...
import com.android.gallery3d.v5.filtershow.cache.BitmapCache;
import com.android.gallery3d.v5.filtershow.cache.ImageLoader;
import com.android.gallery3d.v5.filtershow.filters.BaseFiltersManager;
...
import com.android.gallery3d.v5.filtershow.imageshow.GeometryMathUtils;
import com.android.gallery3d.v5.filtershow.imageshow.MasterImage;
import com.android.gallery3d.v5.filtershow.state.State;
...
public class ImagePreset {
    ...
    public void modifyEidtorIcon(){
    	 for (int i = 0; i < mFilters.size(); i++) {
             FilterRepresentation sourceRepresentation = mFilters.elementAt(i);
             if(sourceRepresentation instanceof FilterBasicRepresentation){
            	 ((FilterBasicRepresentation)sourceRepresentation).setValue(50);
             }
         }
    }
